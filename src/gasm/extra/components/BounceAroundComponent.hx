...
import gasm.extra.behaviors.BounceBehavior;
...
/*		_bounceBehaviour = new BounceBehavior(gravity, minX, minY, maxX, maxY);*/
	...
	override public function update(delta:Float) 
	{
		...
		/*var pos = _bounceBehaviour.act(model.x, model.y);
		model.x = pos.x;
		model.y = pos.y;*/
